...
<body id="page-top" class="index">
    ...
    <section>
        <h3 align="center">About Project Columbus</h3>
        <div class="your-centered-div">
            <span style="margin-left:24em">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/H5dguwIoz1k" frameborder="0" allowfullscreen></iframe>
            </span>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>Project Columbus is a network where students can exchange their interview experiences from any company. Students can pinpoint what the structure of the interviews are and thus study more efficiently for them.</p>
                </div>
                <div class="col-lg-4">
                    <p>In the competitive world today, jobs are getting harder and harder to find as companies look for candidates that can show them why they would be a great fit for them. Through this platform, students would be able to find out what past students had experienced in their interviews and how to approach an interview to make the most out of it.</p>
                </div>
            </div>
        </div>
    </section>
